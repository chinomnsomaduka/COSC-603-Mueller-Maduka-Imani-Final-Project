...
/**
 * The class <code>ImprovementMissionTest</code> contains tests for the class <code>{@link ImprovementMission}</code>.
 *
 * @generatedBy CodePro at 5/17/16 5:20 AM
 * @author Chin
 * @version $Revision: 1.0 $
 */
public class ImprovementMissionTest {
	/**
	 * Run the ImprovementMission(Game) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/17/16 5:20 AM
	 */
	@Test
	public void testImprovementMission_1()
		throws Exception {
		Game game = new Game();

		ImprovementMission result = new ImprovementMission(game);
		...
		//       at net.sf.freecol.common.model.mission.ImprovementMission.<init>(ImprovementMission.java:53)
		assertNotNull(result);
	}

	/**
	 * Run the ImprovementMission(Game,String) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/17/16 5:20 AM
	 */
	@Test
	public void testImprovementMission_2()
		throws Exception {
		Game game = new Game();
		String id = "";

		ImprovementMission result = new ImprovementMission(game, id);
		...
		//       at net.sf.freecol.common.model.mission.ImprovementMission.<init>(ImprovementMission.java:75)
		assertNotNull(result);
	}

	/**
	 * Run the ImprovementMission(Game,FreeColXMLReader) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/17/16 5:20 AM
	 */
	@Test
	public void testImprovementMission_3()
		throws Exception {
		Game game = new Game();
		FreeColXMLReader xr = new FreeColXMLReader(new BufferedInputStream(new ByteArrayInputStream("".getBytes())));

		ImprovementMission result = new ImprovementMission(game, xr);

		// add additional test code here
		assertNotNull(result);
		assertEquals(false, result.isValid());
		assertEquals("improvementMission", result.getXMLTagName());
		assertEquals(null, result.getImprovement());
		...
		assertEquals("net.sf.freecol.common.model.mission.ImprovementMission:null", result.toString());
		assertEquals(null, result.getId());
		assertEquals(null, result.getSuffix());
		assertEquals("<improvementMission turnCount=\"0\" repeatCount=\"1\"></improvementMission>", result.serialize());
	...
	public void testDoMission_1()
		throws Exception {
		ImprovementMission fixture = new ImprovementMission(new Game());
		fixture.setImprovement(new TileImprovement(new Game(), ""));
	...
	/**
	 * Run the TileImprovement getImprovement() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/17/16 5:20 AM
	...
	public void testGetImprovement_1()
		...
		TileImprovement result = fixture.getImprovement();
	...
	public void testGetTagName_1()
		...
		String result = ImprovementMission.getTagName();

		// add additional test code here
		assertEquals("improvementMission", result);
	}
	...
	public void testIsValid_3()
		throws Exception {
		ImprovementMission fixture = new ImprovementMission(new Game());
		fixture.setImprovement((TileImprovement) null);
	...
	public void testIsValidFor_1()
		...
		boolean result = ImprovementMission.isValidFor(unit);
	...
	/**
	 * Run the void setImprovement(TileImprovement) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/17/16 5:20 AM
	 */
	@Test
	public void testSetImprovement_1()
		throws Exception {
		ImprovementMission fixture = new ImprovementMission(new Game());
		fixture.setImprovement(new TileImprovement(new Game(), ""));
		TileImprovement newImprovement = new TileImprovement(new Game(), "");

		fixture.setImprovement(newImprovement);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ImprovementMissionTest.class);
	}
}